...
export const TEAMS_26: TournamentStructure = {
  teamCount: 26,
  seedMap: [1, 11, 21, 31, 41, 51, 61, 71, 73, 63, 53, 43, 33, 23, 14, 4, 2, 12, 22, 32, 42, 52, 62, 72, 13, 3],
  groups: [
  ...
  roundOneRaces: [
    ...
    { raceNum: 6, homeSlot: 31, awaySlot: 32 },
    { raceNum: 7, homeSlot: 41, awaySlot: 42 },
    { raceNum: 8, homeSlot: 51, awaySlot: 52 },
    { raceNum: 9, homeSlot: 61, awaySlot: 62 },
    { raceNum: 10, homeSlot: 71, awaySlot: 72 },
    { raceNum: 11, homeSlot: 2, awaySlot: 3 },
    { raceNum: 12, homeSlot: 4, awaySlot: 1 },
    { raceNum: 13, homeSlot: 12, awaySlot: 13 },
    { raceNum: 14, homeSlot: 14, awaySlot: 11 },
    { raceNum: 15, homeSlot: 22, awaySlot: 23 },
    { raceNum: 16, homeSlot: 32, awaySlot: 33 },
    { raceNum: 17, homeSlot: 42, awaySlot: 43 },
    { raceNum: 18, homeSlot: 52, awaySlot: 53 },
    { raceNum: 19, homeSlot: 62, awaySlot: 63 },
    { raceNum: 20, homeSlot: 72, awaySlot: 73 },
    { raceNum: 21, homeSlot: 1, awaySlot: 3 },
    { raceNum: 22, homeSlot: 2, awaySlot: 4 },
    { raceNum: 23, homeSlot: 11, awaySlot: 13 },
    { raceNum: 24, homeSlot: 12, awaySlot: 14 },
    { raceNum: 25, homeSlot: 23, awaySlot: 21 },
    { raceNum: 26, homeSlot: 33, awaySlot: 31 },
    { raceNum: 27, homeSlot: 43, awaySlot: 41 },
    { raceNum: 28, homeSlot: 53, awaySlot: 51 },
    { raceNum: 29, homeSlot: 63, awaySlot: 61 },
    { raceNum: 30, homeSlot: 73, awaySlot: 71 },
  ],
  roundTwoGroups: [
    {
      groupNum: 'I',
    ...
    },
    {
      ...
      seedingEntries: [
        ...
        { positionCode: 'E4', letter: 'Z', label: 'Loser E' },
      ],
      races: [
        { raceNum: 1, homeLetter: 'Y', awayLetter: 'Z' },
        { raceNum: 2, homeLetter: 'Z', awayLetter: 'Y' },
        { raceNum: 3, homeLetter: 'Y', awayLetter: 'Z' },
  ...
  roundOneRaceCount: 30,
  roundTwoRaceCount: 39,
};
