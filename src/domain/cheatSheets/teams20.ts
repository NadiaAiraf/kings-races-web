...
export const TEAMS_20: TournamentStructure = {
  teamCount: 20,
  seedMap: [1, 11, 21, 31, 41, 51, 53, 43, 33, 23, 14, 4, 2, 12, 22, 32, 42, 52, 13, 3],
  groups: [
    { letter: 'A', teamSlots: [1, 2, 3, 4] },
    { letter: 'B', teamSlots: [21, 22, 23] },
    { letter: 'C', teamSlots: [41, 42, 43] },
    { letter: 'D', teamSlots: [11, 12, 13, 14] },
    { letter: 'E', teamSlots: [31, 32, 33] },
    { letter: 'F', teamSlots: [51, 52, 53] },
  ],
  roundOneRaces: [
    ...
    { raceNum: 19, homeSlot: 13, awaySlot: 11 },
    { raceNum: 20, homeSlot: 12, awaySlot: 14 },
    { raceNum: 21, homeSlot: 23, awaySlot: 21 },
    { raceNum: 22, homeSlot: 33, awaySlot: 31 },
    { raceNum: 23, homeSlot: 43, awaySlot: 41 },
    { raceNum: 24, homeSlot: 53, awaySlot: 51 },
  ],
  roundTwoGroups: [
    {
      groupNum: 'I',
    ...
    },
    {
      ...
      seedingEntries: [
        ...
        { positionCode: 'C3', letter: 'N', label: 'Loser C' },
        { positionCode: 'E3', letter: 'O', label: 'Loser E' },
        { positionCode: 'D3', letter: 'P', label: 'Third D' },
      ],
      races: [
    ...
    },
    {
      groupNum: 'VI',
      seedingEntries: [
        { positionCode: 'B3', letter: 'Q', label: 'Loser B' },
        { positionCode: 'D4', letter: 'R', label: 'Loser D' },
        { positionCode: 'F3', letter: 'S', label: 'Loser F' },
        { positionCode: 'A3', letter: 'T', label: 'Third A' },
      ],
      races: [
  ...
  finals: [
    { label: '19th/20th', homeRef: 'Loser Group V', awayRef: 'Loser Group VI' },
    { label: '17th/18th', homeRef: 'Third Group V', awayRef: 'Third Group VI' },
