...
export const TEAMS_14: TournamentStructure = {
  teamCount: 14,
  seedMap: [1, 11, 21, 31, 33, 23, 14, 4, 2, 12, 22, 32, 13, 3],
  groups: [
  ...
  roundOneRaces: [
    ...
    { raceNum: 8, homeSlot: 4, awaySlot: 1 },
    { raceNum: 9, homeSlot: 12, awaySlot: 13 },
    { raceNum: 10, homeSlot: 14, awaySlot: 11 },
    { raceNum: 11, homeSlot: 22, awaySlot: 23 },
    { raceNum: 12, homeSlot: 32, awaySlot: 33 },
    { raceNum: 13, homeSlot: 1, awaySlot: 3 },
    { raceNum: 14, homeSlot: 2, awaySlot: 4 },
    { raceNum: 15, homeSlot: 11, awaySlot: 13 },
    { raceNum: 16, homeSlot: 12, awaySlot: 14 },
  ...
  roundTwoGroups: [
    ...
    },
    {
      groupNum: 'IV',
      seedingEntries: [
        { positionCode: 'B3', letter: 'L', label: 'Third B' },
        { positionCode: 'A4', letter: 'M', label: 'Loser A' },
        { positionCode: 'D3', letter: 'N', label: 'Loser D' },
      ],
      races: [
  ...
  finals: [
    { label: '13th/14th', homeRef: 'Loser Group III', awayRef: 'Loser Group IV' },
