...
export const TEAMS_22: TournamentStructure = {
  ...
  roundOneRaces: [
    ...
    { raceNum: 8, homeSlot: 63, awaySlot: 64 },
    ...
    { raceNum: 16, homeSlot: 64, awaySlot: 61 },
    ...
    { raceNum: 23, homeSlot: 61, awaySlot: 63 },
    { raceNum: 24, homeSlot: 62, awaySlot: 64 },
  ],
  roundTwoGroups: [
    {
      groupNum: 'I',
    ...
    },
    {
      ...
      seedingEntries: [
        ...
        { positionCode: 'D2', letter: 'H', label: 'Runner Up D' },
      ],
      races: [
