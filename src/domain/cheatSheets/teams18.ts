...
export const TEAMS_18: TournamentStructure = {
  teamCount: 18,
  seedMap: [1, 11, 21, 31, 41, 51, 53, 43, 33, 23, 13, 3, 2, 12, 22, 32, 42, 52],
  groups: [
  ...
  roundOneRaces: [
    ...
    { raceNum: 12, homeSlot: 52, awaySlot: 53 },
    ...
    { raceNum: 18, homeSlot: 53, awaySlot: 51 },
  ],
  roundTwoGroups: [
    {
      groupNum: 'I',
    ...
    },
    {
      ...
      seedingEntries: [
        ...
        { positionCode: 'F3', letter: 'R', label: 'Loser F' },
      ],
      races: [
        { raceNum: 1, homeLetter: 'P', awayLetter: 'Q' },
        { raceNum: 2, homeLetter: 'Q', awayLetter: 'R' },
        { raceNum: 3, homeLetter: 'R', awayLetter: 'P' },

      ],
    },
  ],
  finals: [
    { label: '17th/18th', homeRef: 'Loser Group V', awayRef: 'Loser Group VI' },
