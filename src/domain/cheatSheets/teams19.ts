...
export const TEAMS_19: TournamentStructure = {
  teamCount: 19,
  seedMap: [1, 11, 21, 31, 41, 51, 53, 43, 33, 23, 13, 4, 2, 12, 22, 32, 42, 52, 3],
  groups: [
  ...
  roundOneRaces: [
    ...
    { raceNum: 17, homeSlot: 13, awaySlot: 11 },
    { raceNum: 18, homeSlot: 23, awaySlot: 21 },
    { raceNum: 19, homeSlot: 33, awaySlot: 31 },
    { raceNum: 20, homeSlot: 43, awaySlot: 41 },
    { raceNum: 21, homeSlot: 53, awaySlot: 51 },
  ],
  roundTwoGroups: [
    {
      groupNum: 'I',
    ...
    },
    {
      groupNum: 'VI',
      seedingEntries: [
        { positionCode: 'A3', letter: 'P', label: 'Third A' },
      ...
      races: [
        ...
        { raceNum: 3, homeLetter: 'Q', awayLetter: 'R' },
        { raceNum: 4, homeLetter: 'S', awayLetter: 'P' },
        { raceNum: 5, homeLetter: 'P', awayLetter: 'R' },
        { raceNum: 6, homeLetter: 'Q', awayLetter: 'S' },
